...
public class AdServiceLink {
    ...
    @Expose
    private ContextLinkList__1 contextLinkList;
    ...
    public ContextLinkList__1 getContextLinkList() {
        return contextLinkList;
    }

    public void setContextLinkList(ContextLinkList__1 contextLinkList) {
